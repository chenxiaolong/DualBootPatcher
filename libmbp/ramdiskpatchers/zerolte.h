...
class ZerolteBaseRP : public RamdiskPatcher
{
public:
    explicit ZerolteBaseRP(const PatcherConfig * const pc,
                           const FileInfo * const info,
                           CpioFile * const cpio);
    virtual ~ZerolteBaseRP();
...
class ZerolteDefaultRP : public ZerolteBaseRP
{
public:
    explicit ZerolteDefaultRP(const PatcherConfig * const pc,
                              const FileInfo * const info,
                              CpioFile * const cpio);
