...
const std::string BaconRP::Id = "bacon/default";

BaconRP::BaconRP(const PatcherConfig * const pc,
...
PatcherError BaconRP::error() const
{
    return m_impl->error;
}

std::string BaconRP::id() const
{
    return Id;
}

bool BaconRP::patchRamdisk()
{
