...
#define SONY_E_TYPE_KERNEL      PT_LOAD
#define SONY_E_TYPE_RAMDISK     PT_LOAD
#define SONY_E_TYPE_IPL         PT_LOAD
#define SONY_E_TYPE_CMDLINE     PT_NOTE
#define SONY_E_TYPE_RPM         PT_LOAD
#define SONY_E_TYPE_APPSBL      PT_LOAD
