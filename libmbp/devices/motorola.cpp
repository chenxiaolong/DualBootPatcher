...
void addMotorolaDevices(std::vector<Device *> *devices)
{
    ...
    device->twOptions()->flags = Device::FLAG_TW_IGNORE_MAJOR_AXIS_0
    ...
    device = new Device();
    device->setId("titan");
    device->setCodenames({ "titan_umts", "titan_umtsds", "titan_umts",
        "titan_udstv", "xt1063", "xt1068", "xt1064", "xt1069" });
    ...
    device = new Device();
    device->setId("condor");
    device->setCodenames({ "condor", "condor_umts", "condor_umtsds", "xt1022",
        "xt1021", "xt1023" });
    ...
    // Motorola Moto E 3G (2nd Gen)
    device = new Device();
    device->setId("otus");
    device->setCodenames({ "otus", "otus_ds", "otus", "xt1505", "xt1506",
        "xt1511" });
    device->setName("Motorola Moto E 3G (2nd Gen)");
    device->setBlockDevBaseDirs({ QCOM_BASE_DIR });
    ...
    // Motorola Moto E 4G (2nd Gen)
    device = new Device();
    device->setId("surnia");
    device->setCodenames({ "surnia", "surnia_cdma", "surnia_boost",
        "surnia_verizon", "surnia_umts", "surnia_cricket", "surnia_retus",
        "surnia_tefla", "xt1514", "xt1521", "xt1523", "xt1524", "xt1526",
        "xt1527" });
    device->setName("Motorola Moto E 4G (2nd Gen)");
    device->setBlockDevBaseDirs({ QCOM_BASE_DIR });
    ...
    device->setCodenames({ "ghost", "ghost_att", "ghost_rcica", "ghost_retail",
        "ghost_sprint", "ghost_usc", "ghost_verizon", "xt1052", "xt1053",
