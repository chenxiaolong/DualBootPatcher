...
struct FileSELinuxGetLabelErrorBuilder {
  ...
  void add_errno_value(int32_t errno_value) { fbb_.AddElement<int32_t>(FileSELinuxGetLabelError::VT_ERRNO_VALUE, errno_value, 0); }
  void add_msg(flatbuffers::Offset<flatbuffers::String> msg) { fbb_.AddOffset(FileSELinuxGetLabelError::VT_MSG, msg); }
  FileSELinuxGetLabelErrorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  ...
  flatbuffers::Offset<FileSELinuxGetLabelError> Finish() {
    auto o = flatbuffers::Offset<FileSELinuxGetLabelError>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<FileSELinuxGetLabelError> CreateFileSELinuxGetLabelError(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<FileSELinuxGetLabelError> CreateFileSELinuxGetLabelErrorDirect(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t errno_value = 0,
    const char *msg = nullptr) {
  return CreateFileSELinuxGetLabelError(_fbb, errno_value, msg ? _fbb.CreateString(msg) : 0);
}
...
struct FileSELinuxGetLabelResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const FileSELinuxGetLabelError *error() const { return GetPointer<const FileSELinuxGetLabelError *>(VT_ERROR); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FileSELinuxGetLabelResponseBuilder {
  ...
  void add_error(flatbuffers::Offset<FileSELinuxGetLabelError> error) { fbb_.AddOffset(FileSELinuxGetLabelResponse::VT_ERROR, error); }
  ...
  flatbuffers::Offset<FileSELinuxGetLabelResponse> Finish() {
    auto o = flatbuffers::Offset<FileSELinuxGetLabelResponse>(fbb_.EndTable(start_, 4));
    return o;
  }
};
...
inline flatbuffers::Offset<FileSELinuxGetLabelResponse> CreateFileSELinuxGetLabelResponseDirect(flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false,
    const char *error_msg = nullptr,
    const char *label = nullptr,
    flatbuffers::Offset<FileSELinuxGetLabelError> error = 0) {
  return CreateFileSELinuxGetLabelResponse(_fbb, success, error_msg ? _fbb.CreateString(error_msg) : 0, label ? _fbb.CreateString(label) : 0, error);
}
