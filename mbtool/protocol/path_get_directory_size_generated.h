...
struct PathGetDirectorySizeErrorBuilder {
  ...
  void add_errno_value(int32_t errno_value) { fbb_.AddElement<int32_t>(PathGetDirectorySizeError::VT_ERRNO_VALUE, errno_value, 0); }
  void add_msg(flatbuffers::Offset<flatbuffers::String> msg) { fbb_.AddOffset(PathGetDirectorySizeError::VT_MSG, msg); }
  PathGetDirectorySizeErrorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  ...
  flatbuffers::Offset<PathGetDirectorySizeError> Finish() {
    auto o = flatbuffers::Offset<PathGetDirectorySizeError>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<PathGetDirectorySizeError> CreatePathGetDirectorySizeError(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<PathGetDirectorySizeError> CreatePathGetDirectorySizeErrorDirect(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t errno_value = 0,
    const char *msg = nullptr) {
  return CreatePathGetDirectorySizeError(_fbb, errno_value, msg ? _fbb.CreateString(msg) : 0);
}
...
struct PathGetDirectorySizeResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const PathGetDirectorySizeError *error() const { return GetPointer<const PathGetDirectorySizeError *>(VT_ERROR); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct PathGetDirectorySizeResponseBuilder {
  ...
  void add_error(flatbuffers::Offset<PathGetDirectorySizeError> error) { fbb_.AddOffset(PathGetDirectorySizeResponse::VT_ERROR, error); }
  ...
  flatbuffers::Offset<PathGetDirectorySizeResponse> Finish() {
    auto o = flatbuffers::Offset<PathGetDirectorySizeResponse>(fbb_.EndTable(start_, 4));
    return o;
  }
};
...
inline flatbuffers::Offset<PathGetDirectorySizeResponse> CreatePathGetDirectorySizeResponseDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    uint64_t size = 0,
    flatbuffers::Offset<PathGetDirectorySizeError> error = 0) {
  return CreatePathGetDirectorySizeResponse(_fbb, success, error_msg ? _fbb.CreateString(error_msg) : 0, size, error);
}
