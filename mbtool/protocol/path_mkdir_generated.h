...
struct PathMkdirErrorBuilder {
  ...
  void add_errno_value(int32_t errno_value) { fbb_.AddElement<int32_t>(PathMkdirError::VT_ERRNO_VALUE, errno_value, 0); }
  void add_msg(flatbuffers::Offset<flatbuffers::String> msg) { fbb_.AddOffset(PathMkdirError::VT_MSG, msg); }
  PathMkdirErrorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  PathMkdirErrorBuilder &operator=(const PathMkdirErrorBuilder &);
  flatbuffers::Offset<PathMkdirError> Finish() {
    auto o = flatbuffers::Offset<PathMkdirError>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<PathMkdirError> CreatePathMkdirError(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<PathMkdirError> CreatePathMkdirErrorDirect(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t errno_value = 0,
    const char *msg = nullptr) {
  return CreatePathMkdirError(_fbb, errno_value, msg ? _fbb.CreateString(msg) : 0);
}
...
struct PathMkdirResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const PathMkdirError *error() const { return GetPointer<const PathMkdirError *>(VT_ERROR); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct PathMkdirResponseBuilder {
  ...
  void add_error(flatbuffers::Offset<PathMkdirError> error) { fbb_.AddOffset(PathMkdirResponse::VT_ERROR, error); }
  ...
  flatbuffers::Offset<PathMkdirResponse> Finish() {
    auto o = flatbuffers::Offset<PathMkdirResponse>(fbb_.EndTable(start_, 3));
    return o;
  }
};
...
inline flatbuffers::Offset<PathMkdirResponse> CreatePathMkdirResponseDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    flatbuffers::Offset<PathMkdirError> error = 0) {
  return CreatePathMkdirResponse(_fbb, success, error_msg ? _fbb.CreateString(error_msg) : 0, error);
}
