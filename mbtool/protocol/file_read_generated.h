...
struct FileReadErrorBuilder {
  ...
  void add_errno_value(int32_t errno_value) { fbb_.AddElement<int32_t>(FileReadError::VT_ERRNO_VALUE, errno_value, 0); }
  void add_msg(flatbuffers::Offset<flatbuffers::String> msg) { fbb_.AddOffset(FileReadError::VT_MSG, msg); }
  FileReadErrorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  FileReadErrorBuilder &operator=(const FileReadErrorBuilder &);
  flatbuffers::Offset<FileReadError> Finish() {
    auto o = flatbuffers::Offset<FileReadError>(fbb_.EndTable(start_, 2));
    return o;
  }
};

inline flatbuffers::Offset<FileReadError> CreateFileReadError(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<FileReadError> CreateFileReadErrorDirect(flatbuffers::FlatBufferBuilder &_fbb,
    int32_t errno_value = 0,
    const char *msg = nullptr) {
  return CreateFileReadError(_fbb, errno_value, msg ? _fbb.CreateString(msg) : 0);
}
...
struct FileReadResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const FileReadError *error() const { return GetPointer<const FileReadError *>(VT_ERROR); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FileReadResponseBuilder {
  ...
  void add_error(flatbuffers::Offset<FileReadError> error) { fbb_.AddOffset(FileReadResponse::VT_ERROR, error); }
  ...
  flatbuffers::Offset<FileReadResponse> Finish() {
    auto o = flatbuffers::Offset<FileReadResponse>(fbb_.EndTable(start_, 5));
    return o;
  }
};
...
inline flatbuffers::Offset<FileReadResponse> CreateFileReadResponseDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    flatbuffers::Offset<FileReadError> error = 0) {
  return CreateFileReadResponse(_fbb, success, error_msg ? _fbb.CreateString(error_msg) : 0, bytes_read, data ? _fbb.CreateVector<uint8_t>(*data) : 0, error);
}
