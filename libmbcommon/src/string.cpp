 ...
 */
Expected<std::string> format_safe(const char *fmt, ...)
{
    va_list ap;
 ...
 * \return Resulting formatted string or error.
 */
Expected<std::string> format_v_safe(const char *fmt, va_list ap)
{
 ...
 */
Expected<void> mem_insert(void **mem, size_t *mem_size, size_t pos,
 ...
 * \return Nothing if successful. Otherwise, the error.
 */
Expected<void> str_insert(char **str, size_t pos, const char *s)
{
    size_t str_size;
 ...
 * \return Nothing if successful. Otherwise, the error.
 */
Expected<void> mem_replace(void **mem, size_t *mem_size,
 ...
 * \return Nothing if successful. Otherwise, the error.
 */
Expected<void> str_replace(char **str, const char *from, const char *to,
                           size_t n, size_t *n_replaced)
{
