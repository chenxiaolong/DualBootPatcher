...
struct FileCallbacksTest : testing::Test
{
    ...
    static Expected<void> _open_cb(File &file, void *userdata)
    {
        (void) file;
    ...
    static Expected<void> _close_cb(File &file, void *userdata)
    {
        (void) file;
    ...
    static Expected<size_t> _read_cb(File &file, void *userdata,
                                     void *buf, size_t size)
    {
        ...
        return make_error<ECError>(std::error_code{});
    }

    static Expected<size_t> _write_cb(File &file, void *userdata,
    ...
    static Expected<uint64_t> _seek_cb(File &file, void *userdata,
    ...
    static Expected<void> _truncate_cb(File &file, void *userdata,
                                       uint64_t size)
    {
        (void) file;
        (void) size;
