...
if(NOT ANDROID)
    ...
    if (${MBP_BUILD_TARGET} STREQUAL desktop)
        # cmake 3.7 has a bug where add_custom_command() appends the target name
        # as an argument if running an imported command. This breaks cross
        # compiling for Windows because qt5_add_resources() calls
        # add_custom_command() with the Qt5::rcc target.
        #
