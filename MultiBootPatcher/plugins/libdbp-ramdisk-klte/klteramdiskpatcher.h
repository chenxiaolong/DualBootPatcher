...
class KlteRamdiskPatcherPrivate;

class KlteRamdiskPatcher : public RamdiskPatcher
{
public:
    explicit KlteRamdiskPatcher(const PatcherPaths * const pp,
                                const QString &id,
...
private:
    ...
    const QScopedPointer<KlteRamdiskPatcherPrivate> d_ptr;
    Q_DECLARE_PRIVATE(KlteRamdiskPatcher)
};
