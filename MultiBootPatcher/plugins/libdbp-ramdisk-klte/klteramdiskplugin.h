...
#ifndef KLTERAMDISKPLUGIN_H
#define KLTERAMDISKPLUGIN_H
...
class KlteRamdiskPlugin : public QObject,
                          public IRamdiskPatcherFactory
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.github.chenxiaolong.libdbp.IRamdiskPatcherFactory/1.0" FILE "libdbp-ramdisk-klte.json")
    Q_INTERFACES(IRamdiskPatcherFactory)

public:
    KlteRamdiskPlugin(QObject *parent = 0);
