...
public class LibMbp {
    ...
    public static class PatcherError implements Parcelable {
        ...
        public static interface ErrorCode {
            ...
            public static int BOOT_IMAGE_NO_RAMDISK_ADDRESS_ERROR = 12;
            public static int CPIO_FILE_ALREADY_EXIST_ERROR = 13;
            public static int CPIO_FILE_NOT_EXIST_ERROR = 14;
            public static int ARCHIVE_READ_OPEN_ERROR = 15;
            public static int ARCHIVE_READ_DATA_ERROR = 16;
            public static int ARCHIVE_READ_HEADER_ERROR = 17;
            public static int ARCHIVE_WRITE_OPEN_ERROR = 18;
            public static int ARCHIVE_WRITE_DATA_ERROR = 19;
            public static int ARCHIVE_WRITE_HEADER_ERROR = 20;
            public static int ARCHIVE_CLOSE_ERROR = 21;
            public static int ARCHIVE_FREE_ERROR = 22;
            public static int XML_PARSE_FILE_ERROR = 23;
            public static int ONLY_ZIP_SUPPORTED = 24;
            public static int ONLY_BOOT_IMAGE_SUPPORTED = 25;
            public static int PATCHING_CANCELLED = 26;
            public static int SYSTEM_CACHE_FORMAT_LINES_NOT_FOUND = 27;
