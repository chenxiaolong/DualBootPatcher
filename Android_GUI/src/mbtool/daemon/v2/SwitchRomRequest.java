...
public class SwitchRomRequest extends Table {
  public static SwitchRomRequest getRootAsSwitchRomRequest(ByteBuffer _bb) { return getRootAsSwitchRomRequest(_bb, new SwitchRomRequest()); }
  public static SwitchRomRequest getRootAsSwitchRomRequest(ByteBuffer _bb, SwitchRomRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createSwitchRomRequest(FlatBufferBuilder builder,
    ...
    SwitchRomRequest.addForceUpdateChecksums(builder, force_update_checksums);
    return SwitchRomRequest.endSwitchRomRequest(builder);
  }

  public static void startSwitchRomRequest(FlatBufferBuilder builder) { builder.startObject(4); }
