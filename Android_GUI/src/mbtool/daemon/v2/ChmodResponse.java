...
public class ChmodResponse extends Table {
  public static ChmodResponse getRootAsChmodResponse(ByteBuffer _bb) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (new ChmodResponse()).__init(_bb.getInt(_bb.position()) + _bb.position(), _bb); }
