...
public class GetVersionRequest extends Table {
  public static GetVersionRequest getRootAsGetVersionRequest(ByteBuffer _bb) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (new GetVersionRequest()).__init(_bb.getInt(_bb.position()) + _bb.position(), _bb); }
