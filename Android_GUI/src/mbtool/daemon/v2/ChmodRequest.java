...
public class ChmodRequest extends Table {
  public static ChmodRequest getRootAsChmodRequest(ByteBuffer _bb) { return getRootAsChmodRequest(_bb, new ChmodRequest()); }
  public static ChmodRequest getRootAsChmodRequest(ByteBuffer _bb, ChmodRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
