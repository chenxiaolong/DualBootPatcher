...
public final class SignedExecError extends Table {
  ...
  public static SignedExecError getRootAsSignedExecError(ByteBuffer _bb, SignedExecError obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public SignedExecError __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
