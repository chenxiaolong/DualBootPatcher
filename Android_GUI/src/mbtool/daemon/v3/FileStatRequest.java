...
public final class FileStatRequest extends Table {
  ...
  public static FileStatRequest getRootAsFileStatRequest(ByteBuffer _bb, FileStatRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public FileStatRequest __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
