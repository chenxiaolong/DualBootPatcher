...
public final class MbRom extends Table {
  ...
  public static MbRom getRootAsMbRom(ByteBuffer _bb, MbRom obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public MbRom __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
