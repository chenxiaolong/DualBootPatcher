...
public final class PathDeleteError extends Table {
  ...
  public static PathDeleteError getRootAsPathDeleteError(ByteBuffer _bb, PathDeleteError obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public PathDeleteError __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
