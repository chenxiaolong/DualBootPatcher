...
```dosini
android=chenxiaolong/dualbootpatcher:9.3.0-12-android
base=chenxiaolong/dualbootpatcher:9.3.0-12-base
linux=chenxiaolong/dualbootpatcher:9.3.0-12-linux
mingw=chenxiaolong/dualbootpatcher:9.3.0-12-mingw
```
...
docker run --rm -it \
    ...
    chenxiaolong/dualbootpatcher:9.3.0-12-android \
    bash
```
