...
```dosini
android=chenxiaolong/dualbootpatcher:9.3.0-13-android
base=chenxiaolong/dualbootpatcher:9.3.0-13-base
linux=chenxiaolong/dualbootpatcher:9.3.0-13-linux
mingw=chenxiaolong/dualbootpatcher:9.3.0-13-mingw
```
...
docker run --rm -it \
    ...
    chenxiaolong/dualbootpatcher:9.3.0-13-android \
    bash
```
