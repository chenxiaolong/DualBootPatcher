...
```dosini
android=chenxiaolong/dualbootpatcher:9.3.0-11-android
base=chenxiaolong/dualbootpatcher:9.3.0-11-base
linux=chenxiaolong/dualbootpatcher:9.3.0-11-linux
mingw=chenxiaolong/dualbootpatcher:9.3.0-11-mingw
```
...
docker run --rm -it \
    ...
    chenxiaolong/dualbootpatcher:9.3.0-11-android \
    bash
```
