...
```dosini
android=chenxiaolong/dualbootpatcher:9.3.0-2-android
base=chenxiaolong/dualbootpatcher:9.3.0-2-base
linux=chenxiaolong/dualbootpatcher:9.3.0-2-linux
mingw=chenxiaolong/dualbootpatcher:9.3.0-2-mingw
```
...
docker run --rm -it \
    ...
    chenxiaolong/dualbootpatcher:9.3.0-2-android \
    bash
```
