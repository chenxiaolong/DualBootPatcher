...
```dosini
android=chenxiaolong/dualbootpatcher:9.2.0-3-android
base=chenxiaolong/dualbootpatcher:9.2.0-3-base
linux=chenxiaolong/dualbootpatcher:9.2.0-3-linux
mingw=chenxiaolong/dualbootpatcher:9.2.0-3-mingw
```
...
docker run --rm -it \
    ...
    chenxiaolong/dualbootpatcher:9.2.0-3-android \
    bash
```
